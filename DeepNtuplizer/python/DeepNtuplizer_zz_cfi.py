...
for i in range(1,67):
    readFiles.extend( [
        '/store/user/dwalter/TT_Dilepton_v4/ZZ_TuneCUETP8M1_13TeV-pythia8/ZZ/180115_124251/0000/output_0_'+str(i)+'.root'
    ])
...
deepntuplizer = cms.EDAnalyzer('DeepNtuplizer',
                               ...
                               crossSection=cms.double(15400),
                               luminosity = cms.double(35.9),
                               efficiency = cms.double(1./998034)  #1/((effective) number of events
                               )
