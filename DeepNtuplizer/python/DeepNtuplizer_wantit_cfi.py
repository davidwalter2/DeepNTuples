...
for i in range(1,145):
    readFiles.extend( [
        '/store/user/dwalter/TT_Dilepton_v4/ST_tW_antitop_5f_inclusiveDecays_13TeV-powheg-pythia8_TuneCUETP8M1/Wantit/180115_124606/0000/output_0_'+str(i)+'.root'
    ])
...
deepntuplizer = cms.EDAnalyzer('DeepNtuplizer',
                               ...
                               crossSection=cms.double(35600),
                               luminosity = cms.double(35.9),
                               efficiency = cms.double(1./6933094)  #1/((effective) number of events
                               )
