...
for i in range(1,162):
    readFiles.extend( [
        '/store/user/dwalter/TT_Dilepton_v4/ST_tW_top_5f_inclusiveDecays_13TeV-powheg-pythia8_TuneCUETP8M1/Wt/180115_124427/0000/output_0_'+str(i)+'.root'
    ])
...
deepntuplizer = cms.EDAnalyzer('DeepNtuplizer',
                               ...
                               efficiency = cms.double(1./6952830)  #1/((effective) number of events
                               )
