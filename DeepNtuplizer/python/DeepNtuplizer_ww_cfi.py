...
for i in range(1,12): #12
    readFiles.extend( [
        '/store/user/dwalter/TT_Dilepton_v4/WW_TuneCUETP8M1_13TeV-pythia8/WW/180115_124033/0000/output_0_'+str(i)+'.root'
    ])
...
deepntuplizer = cms.EDAnalyzer('DeepNtuplizer',
                               ...
                               crossSection=cms.double(118700),
                               luminosity = cms.double(35.9),
                               efficiency = cms.double(1./994012)  #1/((effective) number of events
                               )
